 ...
 * gcm받으면 startintent - broadcastReceiver에서
 * <p/>
 * <p/>
 * Server API Key help
...
public class DeviceScanActivity extends ListActivity {
    ...
    private BroadcastReceiver receiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            boolean sentToken = com.ourincheon.mygatt.PreferenceManager.instance(getApplicationContext()).sentToken();
        }
    };
    ...
    public void onEvent(DeviceScanActivity deviceScanActivity) {
        ...
        if (dataClass.getmFlag().equals("iWATT.   7F053E9636")) {
            ...
            intent.putExtra(DeviceControlActivity.EXTRAS_DEVICE_NAME, "Bluno");
            intent.putExtra(DeviceControlActivity.EXTRAS_DEVICE_ADDRESS, "20:CD:39:87:79:6D");
        }
        if (mScanning) {
            mBluetoothAdapter.stopLeScan(mLeScanCallback);
            mScanning = false;
